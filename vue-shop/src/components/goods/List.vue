  ...
  <div>
    ...
    <el-card>
      ...
      <el-row :gutter="20">
        ...
        <el-col :span="6">
          <el-button type="primary" icon="el-icon-plus" @click="goGoodsInfo('','add')">添加产品</el-button>
        </el-col>
      </el-row>
      <!-- 用户列表 -->
      <el-table :data="goodsList" border>
        <el-table-column type="index" label="序号"></el-table-column>
        <el-table-column prop="goods_name" label="产品名称" width="300px"></el-table-column>
        <el-table-column prop="goods_price" label="产品价格"></el-table-column>
        <el-table-column prop="goods_weight" label="产品重量"></el-table-column>
        <el-table-column prop="goods_state" label="产品状态"></el-table-column>
    ...
    <!-- 对话框（添加 & 编辑产品） -->
    <el-dialog :title="goodsTitle+'产品'" :visible="goodsDialogVisible"></el-dialog>
  </div>
</template>
<script>
export default {
